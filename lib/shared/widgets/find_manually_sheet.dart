...
/// Shows a bottom sheet to manually select a YouTube video for a song
...
class _FindManuallyContentState extends ConsumerState<_FindManuallyContent> {
  ...
  Future<void> _selectVideo(Track youtubeTrack) async {
    ...
    // Create a track with Spotify metadata but YouTube ID
    ...
    final matchedTrack = Track(
      id: youtubeTrack.id, // YouTube ID for playback
      title: widget.spotifyTrack.name, // Use Spotify title
