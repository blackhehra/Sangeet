...
class DesktopNavigationState {
  ...
  final bool isYouTubeAlbum; // True for YouTube albums (use AlbumDetailPage), false for Spotify albums
...
class DesktopNavigationNotifier extends StateNotifier<DesktopNavigationState> {
  ...
  void openAlbum({
    ...
    String? imageUrl,
    String? subtitle,
    bool isYouTube = false, // True for YouTube albums, false for Spotify albums
    NavigationSource source = NavigationSource.home,
  }) {
    state = DesktopNavigationState(
      playlistId: albumId,
