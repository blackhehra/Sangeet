...
class StreamingServer {
  ...
  Future<_StreamResult?> _tryYoutubeExplodeStream(
    ...
    try {
      ...
      // First, try to find preferred formats (itag 251 or 140)
      ...
      if (opus251.isNotEmpty) {
        // Prefer Opus 251 - best quality for music
        selected = opus251.first;
        print('StreamingServer: [youtube_explode:$clientName] Selected Opus itag 251');
      } else if (aac140.isNotEmpty) {
        // Fallback to AAC 140
        selected = aac140.first;
        print('StreamingServer: [youtube_explode:$clientName] Selected AAC itag 140');
      } else {
        ...
        print('StreamingServer: [youtube_explode:$clientName] Fallback to highest bitrate itag ${selected.tag}');
      }
