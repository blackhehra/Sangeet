...
class SlidingUpPanel extends StatefulWidget {
  ...
  /// When this ValueNotifier's value is true, the panel's internal Listener
  /// will skip processing pointer events. This allows external gesture handlers
  /// (e.g. horizontal swipe on album art) to operate without the panel
  /// simultaneously processing vertical deltas from the same pointer events.
  final ValueNotifier<bool>? gestureDisabled;
