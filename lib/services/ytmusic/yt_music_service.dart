...
/// YTMusic API Service - Based on BlackHole's implementation
/// Uses YouTube Music's internal API for better music search results
  ...
  Track? _parseTrackFromItem(Map childItem, {bool songsOnly = true}) {
    try {
      ...
      if (images.isNotEmpty) {
        ...
        // Fallback to YouTube thumbnail - use maxresdefault for best quality
